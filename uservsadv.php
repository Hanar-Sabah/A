...
<body> 
<div class="container">
  <h2 class="text-center">Please choose if you are a user or an advisor</h2>  
  <div class="row">
    <div class="col-sm-12 text-center mb-3"><a href="dashboard.php" class="btn btn-primary">USER</a></div>
  <div class="col-sm-12 text-center">
  <a href="AdvisorRegisteration.php" class="btn btn-primary">ADVISOR</a>  
  </div>           
  </div>
</div>
</body>
